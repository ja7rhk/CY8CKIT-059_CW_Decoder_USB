...
#define BS_IOPORT_8_VAL ((const uint8 CYFAR *)0x48000000u)

/* PICU_8 Address: CYDEV_PICU_INTTYPE_PICU15_BASE Size (bytes): 8 */
#define BS_PICU_8_VAL ((const uint8 CYFAR *)0x48000008u)
...
static void cfg_dma_init(void)
{
	...
	DMAINITSEC static const struct td_t CYCODE CFG_TD_LIST0[] = {
		...
		{ 1920u, 0x0Du, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P0_U0_BASE) },	/* TD 12 */
		{ 384u, 0x0Eu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P4_U0_BASE) },	/* TD 13 */
		{ 128u, 0x0Fu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P5_U0_BASE) },	/* TD 14 */
		{ 1024u, 0x10u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P6_U0_BASE) },	/* TD 15 */
		...
		{ 384u, 0x13u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P4_U0_BASE) },	/* TD 18 */
		{ 384u, 0x14u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P5_U0_BASE) },	/* TD 19 */
		{ 128u, 0x15u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI1_BASE) },	/* TD 20 */
		{ 128u, 0x16u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI3_BASE) },	/* TD 21 */
		...
		{ 128u, 0x19u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI12_BASE) },	/* TD 24 */
		{ 128u, 0x1Au, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI13_BASE) },	/* TD 25 */
		{ 32u, 0xFEu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYREG_BCTL0_MDCLK_EN) },	/* TD 26 */
		{ 7u, 0x1Cu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_PRTDSI_PRT15_BASE) },	/* TD 27 */
		{ 8u, 0x1Du, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_PICU_INTTYPE_PICU15_BASE) },	/* TD 28 */
		{ 12u, 0xFEu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_TMR0_CFG0) },	/* TD 29 */
		{ 8u, 0x1Fu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_IDMUX_IRQ_CTL0) },	/* TD 30 */
		{ 128u, 0x20u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P5_U1_BASE) },	/* TD 31 */
		{ 128u, 0x21u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI13_BASE + 0x00000080u) },	/* TD 32 */
		{ 128u, 0x22u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI12_BASE + 0x00000080u) },	/* TD 33 */
		{ 128u, 0x23u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI7_BASE) },	/* TD 34 */
		{ 128u, 0x24u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI7_BASE + 0x00000080u) },	/* TD 35 */
		{ 128u, 0x25u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI6_BASE) },	/* TD 36 */
		{ 128u, 0x26u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI6_BASE + 0x00000080u) },	/* TD 37 */
		{ 128u, 0x27u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI5_BASE + 0x00000080u) },	/* TD 38 */
		{ 128u, 0x28u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI4_BASE) },	/* TD 39 */
		{ 128u, 0x29u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI4_BASE + 0x00000080u) },	/* TD 40 */
		{ 128u, 0x2Au, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P5_ROUTE_BASE + 0x00000080u) },	/* TD 41 */
		{ 128u, 0x2Bu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P2_ROUTE_BASE + 0x00000080u) },	/* TD 42 */
		{ 128u, 0x2Cu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P4_ROUTE_BASE + 0x00000080u) },	/* TD 43 */
		{ 128u, 0x2Du, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P3_ROUTE_BASE + 0x00000080u) },	/* TD 44 */
		...
		{ 128u, 0x30u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P5_ROUTE_BASE) },	/* TD 47 */
		{ 128u, 0x31u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P5_ROUTE_BASE + 0x00000080u) },	/* TD 48 */
		{ 128u, 0x32u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI9_BASE + 0x00000080u) },	/* TD 49 */
		{ 128u, 0x33u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI8_BASE) },	/* TD 50 */
		{ 128u, 0x34u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI8_BASE + 0x00000080u) },	/* TD 51 */
		{ 128u, 0x35u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI3_BASE + 0x00000080u) },	/* TD 52 */
		{ 128u, 0x36u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI2_BASE) },	/* TD 53 */
	...
	static const void * const CFG_TD_ADDR0[] = {
		...
		(const void *)(&DMA_ZERO_VAL),	/* TD 26 */
		(const void *)(BS_IOPORT_8_VAL),	/* TD 27 */
		(const void *)(BS_PICU_8_VAL),	/* TD 28 */
		(const void *)(BS_TMR0_VAL),	/* TD 29 */
		(const void *)(BS_IDMUX_IRQ_VAL),	/* TD 30 */
		(const void *)(BS_UDB_0_3_1_CONFIG_VAL),	/* TD 31 */
		(const void *)(BS_DSI0_0_HV_ROUTING_VAL),	/* TD 32 */
		(const void *)(BS_DSI0_1_HV_ROUTING_VAL),	/* TD 33 */
		(const void *)(BS_DSISWITCH_0_2_VAL),	/* TD 34 */
		(const void *)(BS_DSI0_2_HV_ROUTING_VAL),	/* TD 35 */
		(const void *)(BS_DSISWITCH_0_3_VAL),	/* TD 36 */
		(const void *)(BS_DSI0_3_HV_ROUTING_VAL),	/* TD 37 */
		(const void *)(BS_DSI0_4_HV_ROUTING_VAL),	/* TD 38 */
		(const void *)(BS_DSISWITCH_0_5_VAL),	/* TD 39 */
		(const void *)(BS_DSI0_5_HV_ROUTING_VAL),	/* TD 40 */
		(const void *)(BS_UDB_1_0_HV_ROUTING_VAL),	/* TD 41 */
		(const void *)(BS_UDB_2_0_HV_ROUTING_VAL),	/* TD 42 */
		(const void *)(BS_UDB_1_1_HV_ROUTING_VAL),	/* TD 43 */
		(const void *)(BS_UDB_2_1_HV_ROUTING_VAL),	/* TD 44 */
		(const void *)(BS_UDB_1_2_HV_ROUTING_VAL),	/* TD 45 */
		(const void *)(BS_UDB_2_2_HV_ROUTING_VAL),	/* TD 46 */
		(const void *)(BS_UDBSWITCH_0_3_VAL),	/* TD 47 */
		(const void *)(BS_UDB_1_3_HV_ROUTING_VAL),	/* TD 48 */
		(const void *)(BS_DSI3_0_HV_ROUTING_VAL),	/* TD 49 */
		(const void *)(BS_DSISWITCH_1_1_VAL),	/* TD 50 */
		(const void *)(BS_DSI3_1_HV_ROUTING_VAL),	/* TD 51 */
		(const void *)(BS_DSI3_2_HV_ROUTING_VAL),	/* TD 52 */
		(const void *)(BS_DSISWITCH_1_3_VAL),	/* TD 53 */
	...
	CY_SET_REG8((void CYXDATA *)(CYREG_PHUB_CH5_BASIC_STATUS+1u), 0x1Bu);	/* ch5 first TD: 27 */
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG1_CFG0), 0x027Fu);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT3_AMUX, 0x0890u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_BG_CR0, 0x0Cu);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC2_SW0, 0x80u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC2_SW4, 0x20u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC2_SW8, 0x40u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DAC2_SW0, 0x20u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DAC2_SW2, 0x01u);
