...
*
* \funcusage
*  \snippet AF_OUT_SUT.c usage_AF_OUT_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet AF_OUT_SUT.c usage_AF_OUT_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet AF_OUT_SUT.c usage_AF_OUT_Read  
*******************************************************************************/
...
* preferred AF_OUT_Read() API because the 
* AF_OUT_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet AF_OUT_SUT.c usage_AF_OUT_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: AF_OUT_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use AF_OUT_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - AF_OUT_0_INTR       (First pin in the list)
    *  - AF_OUT_1_INTR       (Second pin in the list)
    *  - ...
    *  - AF_OUT_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet AF_OUT_SUT.c usage_AF_OUT_SetInterruptMode
    *******************************************************************************/
    void AF_OUT_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & AF_OUT_0_INTR) != 0u) 
		{ 
			 AF_OUT_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet AF_OUT_SUT.c usage_AF_OUT_ClearInterrupt
    *******************************************************************************/
