// ======================================================================
// CY8CKIT-059_CW_Decoder_USB.v generated from TopDesign.cysch
// 08/11/2021 at 21:13
...
module top ;
    ...
    defparam VDAC8.Initial_Value = 125;
	...
	wire [0:0] tmpOE__AF_IN_net;
	wire [0:0] tmpFB_0__AF_IN_net;
	wire [0:0] tmpIO_0__AF_IN_net;
	wire [0:0] tmpINTERRUPT_0__AF_IN_net;
	electrical [0:0] tmpSIOVREF__AF_IN_net;
	...
	cy_psoc3_pins_v1_10
		...
		AF_IN
		 (.oe(tmpOE__AF_IN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__AF_IN_net[0:0]}),
		  .analog({Net_60}),
		  .io({tmpIO_0__AF_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__AF_IN_net),
		  .interrupt({tmpINTERRUPT_0__AF_IN_net[0:0]}),
		  .annotation({Net_509}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__AF_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__AF_OUT_net;
	wire [0:0] tmpFB_0__AF_OUT_net;
	wire [0:0] tmpIO_0__AF_OUT_net;
	wire [0:0] tmpINTERRUPT_0__AF_OUT_net;
	electrical [0:0] tmpSIOVREF__AF_OUT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("d22fef88-f60e-4282-bad1-fc1bcae18b79"),
		  ...
		  .input_buffer_sel(2'b00))
		AF_OUT
		 (.oe(tmpOE__AF_OUT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__AF_OUT_net[0:0]}),
		  .analog({Net_106}),
		  .io({tmpIO_0__AF_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__AF_OUT_net),
		  .interrupt({tmpINTERRUPT_0__AF_OUT_net[0:0]}),
		  .annotation({Net_16}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__AF_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("6a340c3f-f538-4ecc-97a9-d506516dedfc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("0a2ccf86-5cff-4d87-af9a-102e4abdf362"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("aa8d6cfe-dfdb-41ad-b102-67929015e668"),
	...
	wire [0:0] tmpOE__TONE_net;
	wire [0:0] tmpFB_0__TONE_net;
	wire [0:0] tmpIO_0__TONE_net;
	wire [0:0] tmpINTERRUPT_0__TONE_net;
	electrical [0:0] tmpSIOVREF__TONE_net;

	cy_psoc3_pins_v1_10
		#(.id("9a7c8512-e885-4e05-9cfc-69d83efc1d4a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		TONE
		 (.oe(tmpOE__TONE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TONE_net[0:0]}),
		  .io({tmpIO_0__TONE_net[0:0]}),
		  .siovref(tmpSIOVREF__TONE_net),
		  .interrupt({tmpINTERRUPT_0__TONE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TONE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    OpAmp_v1_90_7 Opamp_2 (
        .Vminus(Net_112),
        .Vout(Net_106),
        .Vplus(Net_110));
    defparam Opamp_2.Mode = 1;

	wire [0:0] tmpOE__MON_ISR_net;
	wire [0:0] tmpFB_0__MON_ISR_net;
	wire [0:0] tmpIO_0__MON_ISR_net;
	wire [0:0] tmpINTERRUPT_0__MON_ISR_net;
	electrical [0:0] tmpSIOVREF__MON_ISR_net;

	cy_psoc3_pins_v1_10
		#(.id("531d5435-67ab-4777-9d9a-16fbbd7aa1b9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		MON_ISR
		 (.oe(tmpOE__MON_ISR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MON_ISR_net[0:0]}),
		  .io({tmpIO_0__MON_ISR_net[0:0]}),
		  .siovref(tmpSIOVREF__MON_ISR_net),
		  .interrupt({tmpINTERRUPT_0__MON_ISR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MON_ISR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PI_KEY_0_net;
	wire [0:0] tmpFB_0__PI_KEY_0_net;
	wire [0:0] tmpIO_0__PI_KEY_0_net;
	wire [0:0] tmpINTERRUPT_0__PI_KEY_0_net;
	electrical [0:0] tmpSIOVREF__PI_KEY_0_net;

	cy_psoc3_pins_v1_10
		#(.id("7485608f-a190-4a79-b950-fb790a7b5ffa"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PI_KEY_0
		 (.oe(tmpOE__PI_KEY_0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PI_KEY_0_net[0:0]}),
		  .io({tmpIO_0__PI_KEY_0_net[0:0]}),
		  .siovref(tmpSIOVREF__PI_KEY_0_net),
		  .interrupt({tmpINTERRUPT_0__PI_KEY_0_net[0:0]}),
		  .annotation({Net_119}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PI_KEY_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PI_KEY_1_net;
	wire [0:0] tmpFB_0__PI_KEY_1_net;
	wire [0:0] tmpIO_0__PI_KEY_1_net;
	wire [0:0] tmpINTERRUPT_0__PI_KEY_1_net;
	electrical [0:0] tmpSIOVREF__PI_KEY_1_net;

	cy_psoc3_pins_v1_10
		#(.id("fac36731-2ec3-4e86-bbfc-371337525ea4"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PI_KEY_1
		 (.oe(tmpOE__PI_KEY_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PI_KEY_1_net[0:0]}),
		  .io({tmpIO_0__PI_KEY_1_net[0:0]}),
		  .siovref(tmpSIOVREF__PI_KEY_1_net),
		  .interrupt({tmpINTERRUPT_0__PI_KEY_1_net[0:0]}),
		  .annotation({Net_126}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PI_KEY_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
